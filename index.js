...
inquirer.prompt([
  {
    type: "list", name: "whattodo", message:["view all departments", "view all roles", "view all employees", "adde a department", "add a role", "add an employee", "update an employee role"]
  }
]).then(answer => {
